    ...
    >
          ...
          <div className="modal-box relative bg-slate-200">
            ...
            <div className="mt-4 w-full">
              <div className="flex flex-row justify-between items-center">
                <label className="text-sm font-bold mr-2">Nama Depan</label>
                <input
                  value={nama_Depan}
              ...
              <div className="flex flex-row justify-between items-center">
                <label className="text-sm font-bold mr-2">Nama Belakang</label>
                <input
                  value={nama_Belakang}
              ...
              <div className="flex flex-row justify-between items-center">
                <label className="text-sm font-bold mr-2">
                  Nomer Handphone
                </label>
                <input
                  minLength="10"
              ...
              <div className="flex flex-row justify-between items-center">
                <label className="text-sm font-bold mr-2">Label Alamat</label>
                <select
                  value={labelAlamat}
              ...
              <div className="flex flex-row justify-between items-center">
                <label className="text-sm font-bold mr-2">Alamat Lengkap</label>
                <input
                  value={alamatLengkap}
              ...
              <span className="text-sm text-gray-500">Update References</span>
              <div className="flex flex-row justify-start items-center">
                {dataReferences.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => setReferensi(item.id)}
                    className={`btn btn-sm rounded-none ml-1 ${
      ...
      <div className="modal">
        <div className="modal-box relative bg-slate-200">
          ...
          <div className="flex flex-row items-center mt-1">
            <button className="btn btn-primary btn-sm mt-2">Konfirmasi</button>
            <label
              htmlFor="my-modal-3"
              className="btn btn-error btn-sm mt-2 ml-2"
            >
